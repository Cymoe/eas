...
export default function RewindsScreen() {
  ...
  const offers = [
    { 
      ...
      unit: 'Rewind', 
      price: '$2', 
      badge: { text: 'Try it first', color: '#575093' } 
    },
    { 
      id: 1, 
      amount: 3, 
      unit: 'Rewinds', 
      price: '$1.75/each', 
      badge: { text: 'Save 33%', color: '#6BFF90' } 
    },
    { 
      id: 2, 
      amount: 6, 
      unit: 'Rewinds', 
      price: '$1/each', 
      badge: { text: 'Save 66%', color: '#6BFF90' }, 
      popular: true 
    }
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Rewinds title section */}
        <View style={styles.titleSection}>
          <Text style={styles.title}>Rewinds <Ionicons name="play-back" size={32} color="#FFFFFF" /></Text>
            ...
            >
              <View style={styles.offerContent}>
                <Text style={styles.offerText}>
                  <Text style={styles.offerAmount}>{offer.amount}</Text> {offer.unit}
                </Text>
                <View style={styles.badgeContainer}>
                  {offer.badge && (
                    <View style={[styles.badge, { backgroundColor: offer.badge.color }]}>
                      <Text style={styles.badgeText}>{offer.badge.text}</Text>
                    </View>
                  )}
                  {offer.popular && (
