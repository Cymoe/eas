...
export default function BoostsScreen() {
  ...
  // Offer data
  const offers = [
    { id: 0, amount: 1, unit: 'Boost', price: '$7' },
    { id: 1, amount: 15, unit: 'Boosts', price: '$6/each' },
    { id: 2, amount: 30, unit: 'Boosts', price: '$5/each', popular: true }
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Boosts title section */}
        <View style={styles.titleSection}>
          <Text style={styles.title}>Boosts <Ionicons name="flash" size={32} color="#575093" /></Text>
